package com.fierte.web.entity.reports;

public class PriceReport {

    private Long price_report_id;
    ...
    public PriceReport(Long price_report_id, Long product_id, Long product_items_id, Integer purchase_price, Integer price,
    ...
    public Long getPrice_report_id() {
        return price_report_id;
    }

    public void setPrice_report_id(Long price_report_id) {
        this.price_report_id = price_report_id;
    }
