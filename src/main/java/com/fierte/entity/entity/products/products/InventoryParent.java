...
public class InventoryParent {
    ...
    public InventoryParent(Long product_id, String product_name, Long category_id, String category_name, Long subcategory_id, String subcategory_name,
                           Integer total_quantity, Integer total_product_type, Integer status, String updated_time){
